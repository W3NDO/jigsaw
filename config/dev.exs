...
config :demo, Demo.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ypZHPxn+Nn81YKOCvux8IDtWe6udnW9hLuRnCwa4DrkyKa6v7HUwNcKGzqanJ3Kb",
  watchers: [
...
config :demo, Demo.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/demo/router\.ex$"E,
      ~r"lib/demo/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
